...
export class v11558528771647 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `favorites` (`owner` varchar(64) NOT NULL, `entity_id` varchar(36) NOT NULL, `entity_type` enum ('0', '1', '2') NOT NULL DEFAULT '0', INDEX `IDX_e42953e6be13870839a04a3fa8` (`entity_id`), PRIMARY KEY (`owner`, `entity_id`)) ENGINE=InnoDB");
