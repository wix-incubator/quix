...
const notebookId = 'examples';

const addNote = (id, name, content) =>  createNote(notebookId, {id, name, content, owner: QuixFolder.owner});
...
`
    ...
    addNote('start-stop-params', 'START_TIME and STOP_TIME parameters', `/* AUTOGENERATED
