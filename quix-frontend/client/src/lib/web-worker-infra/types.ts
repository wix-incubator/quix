/* Constraints */
export interface RQRSConstraint {[key: string]: any}
...
export type ResponseMsgTypes<RS> = keyof RS; //all possible reponse types
...
/*
 * Bit of explenation for this uglyness:
...
//Generic types
export type WorkerResponseDataT<RQ, RS, T extends RequestMsgTypes<RQ>, RQtoRs extends RqtoRSConstraint<RQ, RS>> =
 RS[RQtoRs[T]];
